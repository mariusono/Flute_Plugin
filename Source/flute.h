...
public:
    ...
    void set_freq_vibrato_smoo(double val) { freq_vibrato = (1-0.99)*val + 0.99*freq_vibrato; }

    void set_release_time(double val) { release_time = val; }
    void set_pitchBend(double val) { pitchBend_val = val; }
    ...
    double get_freqVibrato() { return freq_vibrato; }
